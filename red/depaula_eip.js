...
module.exports = function(RED) {
    ...
    function depaula_eip_Endpoint(config) {
        ...
        //avoids warnings when we have a lot of depaula_eip In nodes
    ...
    RED.nodes.registerType("depaula_eip in", depaula_eip_In);
    ...
    RED.nodes.registerType("depaula_eip out", depaula_eip_Out);
};
